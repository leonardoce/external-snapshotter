...
func TestIsVolumeSnapshotGroupMember(t *testing.T) {
	...
	for _, test := range testCases {
		t.Run(test.name, func(t *testing.T) {
			...
			resultParentObject, resultStatus := GetVolumeGroupSnapshotParentObjectName(test.snapshot)
			if resultStatus != test.expected || resultParentObject != test.expectedParentObjectName {
				t.Errorf("GetVolumeGroupSnapshotParentObjectName(s) = %v,%v WANTED %v,%v", resultParentObject, result, test.expectedParentObjectName, test.expected)
			}
