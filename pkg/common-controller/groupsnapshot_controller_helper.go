...
func (ctrl *csiSnapshotCommonController) updateGroupSnapshot(groupSnapshot *crdv1beta1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) syncGroupSnapshot(groupSnapshot *crdv1beta1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) syncUnreadyGroupSnapshot(groupSnapshot *crdv1beta1.VolumeGroupSnapshot) error {
...
func (ctrl *csiSnapshotCommonController) updateGroupSnapshotStatus(groupSnapshot *crdv1beta1.VolumeGroupSnapshot, groupSnapshotContent *crdv1beta1.VolumeGroupSnapshotContent) (*crdv1beta1.VolumeGroupSnapshot, error) {
	...
	var pvcVolumeSnapshotRefList []crdv1beta1.PVCVolumeSnapshotPair
	if groupSnapshotContent.Status != nil && len(groupSnapshotContent.Status.PVVolumeSnapshotContentList) != 0 {
		for _, contentRef := range groupSnapshotContent.Status.PVVolumeSnapshotContentList {
			...
			pvcVolumeSnapshotRefList = append(pvcVolumeSnapshotRefList, crdv1beta1.PVCVolumeSnapshotPair{
...
func (ctrl *csiSnapshotCommonController) processGroupSnapshotWithDeletionTimestamp(groupSnapshot *crdv1beta1.VolumeGroupSnapshot) error {
	...
	if groupSnapshotContent != nil && deleteGroupSnapshotContent {
		...
		err := ctrl.clientset.GroupsnapshotV1beta1().VolumeGroupSnapshotContents().Delete(context.TODO(), groupSnapshotContent.Name, metav1.DeleteOptions{})
		if err != nil {
